...
print
print ("\033[49m                   Welcome To  Sk.virus-X.py              \033[0m")
print ("\033[48m                   Author: MD-SAHADAT-KHAN                   \033[0m")
print
...
def help():
  print
  print ("\033[44m Developer : TEAM SK Brothers BD CRACKERS TEAM\033[0m")
